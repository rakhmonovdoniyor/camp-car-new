...
<input type="text" />
  ...
  <Accordion defaultExpanded= {true} style={{boxShadow: 'none', borderBottom: 'none'}} >
      ...
      <Line></Line>
          ...
          <FormControlLabel control={<Checkbox />} label="Class A Motorhome" onChange={() => handleCheckBoxChange("Class A Motorhome")}/>
          </BrandItems>
    ...
    <Accordion defaultExpanded= {true} style={{boxShadow: 'none', borderBottom: 'none'}}>
      ...
      <Line></Line>
          ...
          <BrandItems>
          <FormControlLabel control={<Checkbox />} label="Nature Nomads"  onChange={() => handleCheckBoxChange("Nature Nomads")}/>
          </BrandItems>
          <BrandItems>
          <FormControlLabel control={<Checkbox />} label="Campfire Cruisers" onChange={() => handleCheckBoxChange("Campfire Cruisers")}/>
          </BrandItems>
          <BrandItems>
          <FormControlLabel control={<Checkbox />} label="Adventure Axle C" onChange={() => handleCheckBoxChange("Adventure Axle C")}/>
          </BrandItems>
          <BrandItems>
          <FormControlLabel control={<Checkbox />} label="TrekKing RV Co." onChange={() => handleCheckBoxChange("TrekKing RV Co.")}/>
          </BrandItems>
          <BrandItems>
          <FormControlLabel control={<Checkbox />} label="Wilderness  Co." onChange={() => handleCheckBoxChange("Wilderness  Co.")}/>
          </BrandItems>
          <BrandItems>
          <FormControlLabel control={<Checkbox />} label="TrailTrekker RVs" onChange={() => handleCheckBoxChange("TrailTrekker RVs")}/>
          </BrandItems>
      </AccordionDetails>
    </Accordion>
    ...
    <Accordion defaultExpanded= {true} style={{boxShadow: 'none', borderBottom: 'none'}}>
      ...
      <Line></Line>
          ...
          <BrandItems>
          <FormControlLabel control={<Checkbox />} label="3" onChange={() => handleCheckBoxChange("3")}/>
          </BrandItems>
      </AccordionDetails>       
    </Accordion>
    ...
    <Accordion defaultExpanded= {true} style={{boxShadow: 'none', borderBottom: 'none'}}>
      ...
      <Line></Line>
          ...
          <BrandItems>
          <FormControlLabel control={<Checkbox />} label="Kyongsan" onChange={() => handleCheckBoxChange("Kyongsan")}/>
           ...
           <ItemRight2>
            ...
            {/* <ButtonHV/> */}
             {/* <BtnWrap2 $iconBtn>
              ...
              <>{active ? <HMenu exportedData = {filterData}/> :  <VMenu2 exportedData = {filterData}/>}</>
     </Item24>
          </Right>
